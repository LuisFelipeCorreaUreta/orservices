...
class CreateLayoutsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('layouts', function (Blueprint $table) {
            ...
            $table->string('top_menu_link_color')->nullable();
            $table->string('menu_title_color')->nullable();
            $table->string('top_menu_link_hover_color')->nullable();
            ...
            $table->longText('exclude_vocabulary')->nullable();
            $table->timestamps();
        });
    }
